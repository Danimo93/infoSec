...
<br>
           ...
           <input type="hidden" name="h" value="include/h.html">
           <input type="hidden" name="f" value="include/f.html">
           <table>
           <tr><td><div class="content">Search Term</div></td><td><input name="q" maxlength="20"></td></tr>
           <tr><td align="right" colspan="2"><input type="submit" value="Search"></td></tr>
           </table>
           </form>
           </div>
